...
package is a collection of functions for processing and analyzing such data.
The namesake function uses spectral binning to convert 1D or 2D NMR data into a
matrix of values
